...
public class Day3 {
    ...
    private static int calcC02Scrub(int[][] input) {
        ...
        for(int col = 0; col < input[0].length; col++) {
            ...
            if (numActiveRows == 1) {
                ...
                //System.out.println("col = " + (col+1) + " leastCommon " + leastCommon);
    ...
    private static int calcOxygenRate(int[][] input) {
        ...
        for(int col = 0; col < input[0].length; col++) {
            ...
            if (numActiveRows == 1) {
                ...
                //System.out.println("col = " + (col+1) + " mostCommon " + mostCommon);
    ...
    private static int calMostCommon(int[][] input, int col, List<Integer> active) {
       ...
       // System.out.println("sum of ones = " + sum);
        //System.out.println("sum of zeroes = " + (numActiveRows - sum));
    ...
    private static List<Integer> calcEpsilonRate(List<Integer> gammaRate) {
        ...
        //System.out.println(epsilonRateBin);
    ...
    private static List<Integer>  calcGammaRate(int[][] input) {
        ...
        //System.out.println(gammaRateBin);
        return gammaRateBin;
    }
    ...
    private static int binToDec(List<Integer> bin) {
        ...
        for (int i = 0; i < bin.size(); i++) {
            ...
            //System.out.println("i = " + i + " bin[i] = " + bin.get(i) + " dec= " + dec);
        }
